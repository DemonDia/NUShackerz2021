...
def retrieve_user_info(chat_id):
  degenerate = InlineKeyboardButton("Degrade", callback_data="Prefer degenerate")
  praise = InlineKeyboardButton("Praise", callback_data="Prefer praise")
  buttons = [[degenerate], [praise]]
  time.sleep(0.3)
  bot.send_message(chat_id,'''Hi! My name is Joi, and I’m your guide to a better GPA. ''')
  time.sleep(0.3)
  bot.send_message(chat_id, '''Before we continue, I want to know more about you. Like, what’s your motivation style?''', reply_markup=InlineKeyboardMarkup(buttons))
